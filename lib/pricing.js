...
const PRICING = {
  ...
  // TODO-vérifier: confirm Opus 4 rates when GA pricing is published
  opus: {
    input: 15,
    output: 75,
    cacheRead: 1.5,
  ...
  // ── Claude Fable (if / when publicly released) ─────────────────────────────
  // TODO-vérifier: placeholder rates — no public pricing as of June 2026
  fable: {
    input: 3,
    output: 15,
    cacheRead: 0.3,
